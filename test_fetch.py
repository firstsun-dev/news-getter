...
class TestFetch(unittest.TestCase):
    def test_articles_carry_tier_and_role_from_feeds_yaml(self):
        ...
        with mock.patch("fetch.yaml.safe_load", return_value=fake_config), \
             mock.patch("fetch.requests.get", return_value=mock.Mock(content=b"<xml/>")), \
             mock.patch("fetch.feedparser.parse", return_value=fake_parsed):
