...
| `src/summarizer.py` | Gemini prompts, `StoryDigest`/`StoryRecord`/`CategoryArchive` Pydantic schemas, and the validation gate — edit here to change summarization style or schema |
